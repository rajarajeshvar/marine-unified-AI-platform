  ...
  useEffect(() => {
    ...
    (async function initIcon() {
      ...
      const sIcon = L.divIcon({
        ...
        html: '<div style="background-color: #f59e0b; width: 40px; height: 40px; border-radius: 50%; border: 3px solid white; box-shadow: 0 0 12px rgba(0,0,0,0.6); display: flex; align-items: center; justify-content: center;"><span style="color:white; font-size: 20px;">🚢</span></div>',
        iconSize: [40, 40],
        iconAnchor: [20, 20]
      });
